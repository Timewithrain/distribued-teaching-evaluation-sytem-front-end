      ...
      <el-tabs :tab-position="tabPosition" v-model="activeName" @tab-click="handleClick">
        ...
        <el-tab-pane label="查看评价" name="search" style="margin-left: 30px;">
          <el-table class="evaluation-table" :data="summaryEvaluationList" style="width: 100%;margin-bottom: 20px;" row-key="id">
            ...
            <el-table-column prop="course.number" label="课程号" width="90">
            </el-table-column>
...
export default {
  ...
  methods: {
    ...
    assembleEvaluation() {
      //计算评价分数
      var totalWeight = this.evaluationItemList[0].weight + this.evaluationItemList[1].weight + this.evaluationItemList[2].weight 
                      + this.evaluationItemList[3].weight + this.evaluationItemList[4].weight + this.evaluationItemList[5].weight
      var totalScore = this.addEvaluationForm.score1 * this.evaluationItemList[0].weight + this.addEvaluationForm.score2 * this.evaluationItemList[1].weight + this.addEvaluationForm.score3 * this.evaluationItemList[2].weight + 
