<template>
  <el-container class="home-container">
   <el-header>
      ...
      <div>
        <span style="font-size: 17px">您好，{{user.name}}督导，欢迎来到督导页面！</span>
...
export default {
  ...
  methods: {
    ...
    getMenuList() {
      var menu = [
        {id: 1, authName: '个人中心', path: 'supervisor-info'},
        {id: 2, authName: '课程管理', path: 'supervisor-course-manage'},
        {id: 3, authName: '教学评价', path: 'supervisor-evaluation'}]
      this.menuList = menu
    },
    toggleCollapse() {
